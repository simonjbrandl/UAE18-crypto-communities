...
bio.pred.plot <- ggplot(data = bio.pred) +
  ...
  scale_fill_manual(values = alpha(uaecols, 0.5)) +
  scale_shape_manual(name = "Site", values = c(21,22,23,21,22,23)) +
  scale_x_log10(limits = c(0.1,1000), breaks=c(0.1,1,10,100,1000), labels=c(0.1,1,10,100,1000)) +
    annotation_logticks(base = 10, sides = "b",
                          short = unit(1,"mm"),
                        mid = unit(1,"mm"),
                        long = unit(2,"mm")) +
...
div.pred.plot <- ggplot(data = div.pred) +
  ...
  scale_fill_manual(values = alpha(uaecols, 0.5)) +
  scale_shape_manual(name = "Site", values = c(21,22,23,21,22,23)) +
  scale_x_log10(limits = c(0.1,100), breaks=c(0.1,1,10,100), labels=c(0.1,1,10,100)) +
  theme_sjb() +
    annotation_logticks(base = 10, sides = "b",
                          short = unit(1,"mm"),
                        mid = unit(1,"mm"),
...
ggsave("Plots/Fig1_MS.png", Fig1, width = 6, height = 8)
```
...
comp_plot
ggsave("Plots/Fig2_MS.png", plot = comp_plot, width = 4, height = 5)
```
...
#run GLM with abundance data and offset for surface area sampled
event.abu.model <- brm(log(Density) ~ Location + (1|Site), 
                            data = abu.event, control = list(adapt_delta = 0.999, max_treedepth = 15))
...
epulc.abu.model <- brm(Abundance ~ Location + (1|Site), 
                            data = abu.epulc,family = po control = list(adapt_delta = 0.999, max_treedepth = 15))
